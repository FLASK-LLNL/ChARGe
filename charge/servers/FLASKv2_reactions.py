...
@click.option("--host", type=str, help="Server host", default="127.0.0.1")
...
def main(model_dir_fwd: str, adapter_weights_fwd: str, model_dir_retro: str, adapter_weights_retro: str, host: str, port: int, transport: str):
    # Check CLI args requirement
