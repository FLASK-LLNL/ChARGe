## ChARGe Chat
This directory contains an example of a multi-turn chat application using the ChARGe framework and the Agent Framework backend. The application allows users to interact with a language model that can utilize various molecular tools to assist in drug discovery tasks.
